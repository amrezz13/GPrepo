...
function getMultiQuetionDiv(num, questionId) {
    ...
    for (var a = 1; a < 5; a++) {
        ...
        answerText.setAttribute("name", "q");
    ...
    var subitthis = document.createElement("button");
    subitthis.classList.add("btn", "btn-danger");
    subitthis.innerHTML = "submit"
    subitthis.addEventListener("click", (function() {
        return submit(this.parentElement.parentElement, this, "mcq");
    }));

    questionTabContainet.appendChild(answersTable);
    questionTabContainet.appendChild(subitthis);
...
function getMultiAnswerDiv(num, questionId) {
    ...
    subitthis.innerHTML = "submit"
    subitthis.addEventListener("click", (function() {
        return submit(this.parentElement.parentElement, this, "maq");
    }));
...
function getShortQuetionDiv(num, questionId) {
    ...
    subitthis.innerHTML = "submit"
    subitthis.addEventListener("click", (function() {
        return submitShort(this.parentElement.parentElement, this, "short answer");
    }));
...
function getCompeletQuestionDiv(num, questionId) {
    ...
    subitthis.innerHTML = "submit"
    subitthis.addEventListener("click", (function() {
        return submit(this.parentElement.parentElement, this, "complete");
    }));
