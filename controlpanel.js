...
function submit(div, question, Qtype) {
    var correct = [];
    if (div.children[0].children[3].children[1].children[0].children[0].children[0].checked) {
        correct.push(div.children[0].children[3].children[1].children[0].children[0].children[0].value);
    }
    if (div.children[0].children[3].children[1].children[1].children[0].children[0].checked) {
        correct.push(div.children[0].children[3].children[1].children[1].children[0].children[0].value);

    }
    if (div.children[0].children[3].children[1].children[2].children[0].children[0].checked) {
        correct.push(div.children[0].children[3].children[1].children[2].children[0].children[0].value);

    }
    if (div.children[0].children[3].children[1].children[3].children[0].children[0].checked) {
        correct.push(div.children[0].children[3].children[1].children[3].children[0].children[0].value);
    ...
    var quetion = {
        ...
        type: Qtype,
        question: div.children[0].children[1].value,
        degree: div.children[1].children[0].children[1].value,
        ans1: div.children[0].children[3].children[1].children[0].children[1].children[0].value,
        ans2: div.children[0].children[3].children[1].children[1].children[1].children[0].value,
        ans3: div.children[0].children[3].children[1].children[2].children[1].children[0].value,
        ans4: div.children[0].children[3].children[1].children[3].children[1].children[0].value,
        coreectans: correct
    }
    objects.push(quetion);
    question.classList.toggle("btn-danger");
    question.classList.toggle("btn-success");
}

function submitShort(div, question, Qtype) {
    ...
    var quetion = {
        ...
        question: div.children[0].children[1].value,
        degree: div.children[1].children[0].children[1].value,
        ans: div.children[0].children[3].value
    }
    objects.push(quetion);
    question.classList.toggle("btn-danger");
    question.classList.toggle("btn-success");
